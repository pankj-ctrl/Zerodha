    ...
    return (
        <div className="container mt-5">
            ...
            <div className="row text-center" style={{ marginTop: "2rem", padding: "2rem" }}>
                <div className="col">
                    <img src="/Assets/zerodhafundhouse.png" alt="This is a zerodha fund house" style={{ width: "50%" }} />
                ...
                <div className="col">
                    <img src="/Assets/sensibullLogo.svg" alt="This is a sensibull logo" style={{ width: "70%" }} />
                ...
                <div className="col">
                    <img src="/Assets/tijori.svg" alt="This is a tijori logo" style={{ width: "47%" }} />
            ...
            <div className="row text-center" style={{ marginTop: "2rem", padding: "2rem" }}>
                <div className="col">
                    <img src="/Assets/streakLogo.png" alt="This is streak logo" style={{ width: "50%" }} />
                ...
                <div className="col">
                    <img src="/Assets/smallcaseLogo.png" alt="This is a smallcase logo" style={{ width: "70%" }} />
                ...
                <div className="col">
                    <img src="/Assets/dittoLogo.png" alt="This is a tijori logo" style={{ width: "47%" }} />
