    ...
    return ( 
        <div>
            ...
            <LeftSection imgUrl={'/Assets/products-coin.png'} headingText={"Coin"} paraText={`Buy direct mutual funds online, commission-\n free, delivered directly to your Demat \n account. Enjoy the investment experience \n on your Android and iOS devices. `}/>
             ...
             <RightSection imgUrl={'/Assets/varsity-products.svg'} headingText={'Varsity mobile'} paraText={` An easy to grasp, collection of stock market \n lessons with in-depth coverage \n and illustrations. Content is broken down into \n bite-size cards to help you learn on the go. `} />
