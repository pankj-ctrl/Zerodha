    ...
    return ( 
        <div className="container" style={{marginTop:"8rem",marginBottom:"8rem"}}>
            ...
            <div className="row text-center" style={{marginTop:"5rem"}}>
                <div className="col">
                    <img src="/public/Assets/pricing0.svg" alt="This is pricing 0 svg image" style={{width:"75%"}} />
                ...
                <div className="col">
                    <img src="/public/Assets/other-trades.svg" alt="This is pricing 20 svg image" style={{width:"75%"}}/>
                ...
                <div className="col">
                    <img src="/public/Assets/pricing0.svg" alt="This is also pricing 0 svg image" style={{width:"75%"}}/>
